...
//        System.out.println(wall_cnt);
    ...
    public static void combination(int[] combi, int depth, int start) { //조합합
        if(depth == 3) {
    ...
    public static void bfs(int[][] map_copy, boolean[][] visited, int x, int y) {  //bfs
